...
from app.widgets.script_editor.seo_worker import SEOOptimizeWorker
from app.widgets.script_editor.preview import PreviewRenderer
...
class ScriptPanel(QWidget):
    ...
    def _on_chunk(self, text: str):
        ...
        html = PreviewRenderer.render_markdown(self._result_buf)
    ...
    def _on_seo_chunk(self, text: str):
        ...
        html = PreviewRenderer.render_markdown(self._seo_result_buf)
        self.result_label.setText(html)
    ...
    def _show_final_result(self, text: str):
        """展示最终结果（渲染 markdown）"""
        html = PreviewRenderer.render_markdown(text)
        self.result_label.setText(html)
